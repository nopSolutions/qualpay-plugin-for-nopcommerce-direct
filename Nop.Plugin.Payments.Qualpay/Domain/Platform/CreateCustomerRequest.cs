...
{
    /// <summary>
    /// Represents Qualpay Customer Vault request to create customer
    /// </summary>
    public class CreateCustomerRequest : CustomerVaultRequest
    {
        #region Methods
        ...
        public override string GetRequestPath() => "platform/vault/customer";
